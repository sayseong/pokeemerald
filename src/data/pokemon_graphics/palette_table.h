const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL_SP(VENUSAUR_GIGA),
    SPECIES_PAL_SP(CHARIZARD_GIGA),
    SPECIES_PAL_SP(BLASTOISE_GIGA),
    SPECIES_PAL_SP(BUTTERFREE_GIGA),
    SPECIES_PAL_SP(PIKACHU_GIGA),
    SPECIES_PAL_SP(MEOWTH_GIGA),
    SPECIES_PAL_SP(MACHAMP_GIGA),
    SPECIES_PAL_SP(GENGAR_GIGA),
    SPECIES_PAL_SP(KINGLER_GIGA),
    SPECIES_PAL_SP(LAPRAS_GIGA),
    SPECIES_PAL_SP(EEVEE_GIGA),
    SPECIES_PAL_SP(SNORLAX_GIGA),
    SPECIES_PAL_SP(GARBODOR_GIGA),
    SPECIES_PAL_SP(MELMETAL_GIGA),
    SPECIES_PAL_SP(CORVIKNIGHT_GIGA),
    SPECIES_PAL_SP(ORBEETLE_GIGA),
    SPECIES_PAL_SP(DREDNAW_GIGA),
    SPECIES_PAL_SP(COALOSSAL_GIGA),
    SPECIES_PAL_SP(FLAPPLE_GIGA),
    SPECIES_PAL_SP(SANDACONDA_GIGA),
    SPECIES_PAL_SP(TOXTRICITY_GIGA),
    SPECIES_PAL_SP(HATTERENE_GIGA),
    SPECIES_PAL_SP(DURALUDON_GIGA),
};
