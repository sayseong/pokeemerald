const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE_BACK(VENUSAUR_GIGA),
    SPECIES_SPRITE_BACK(CHARIZARD_GIGA),
    SPECIES_SPRITE_BACK(BLASTOISE_GIGA),
    SPECIES_SPRITE_BACK(BUTTERFREE_GIGA),
    SPECIES_SPRITE_BACK(PIKACHU_GIGA),
    SPECIES_SPRITE_BACK(MEOWTH_GIGA),
    SPECIES_SPRITE_BACK(MACHAMP_GIGA),
    SPECIES_SPRITE_BACK(GENGAR_GIGA),
    SPECIES_SPRITE_BACK(KINGLER_GIGA),
    SPECIES_SPRITE_BACK(LAPRAS_GIGA),
    SPECIES_SPRITE_BACK(EEVEE_GIGA),
    SPECIES_SPRITE_BACK(SNORLAX_GIGA),
    SPECIES_SPRITE_BACK(GARBODOR_GIGA),
    SPECIES_SPRITE_BACK(MELMETAL_GIGA),
    SPECIES_SPRITE_BACK(CORVIKNIGHT_GIGA),
    SPECIES_SPRITE_BACK(ORBEETLE_GIGA),
    SPECIES_SPRITE_BACK(DREDNAW_GIGA),
    SPECIES_SPRITE_BACK(COALOSSAL_GIGA),
    SPECIES_SPRITE_BACK(FLAPPLE_GIGA),
    SPECIES_SPRITE_BACK(SANDACONDA_GIGA),
    SPECIES_SPRITE_BACK(TOXTRICITY_GIGA),
    SPECIES_SPRITE_BACK(HATTERENE_GIGA),
    SPECIES_SPRITE_BACK(DURALUDON_GIGA),
};
