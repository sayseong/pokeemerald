const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE_FRONT(VENUSAUR_GIGA),
    SPECIES_SPRITE_FRONT(CHARIZARD_GIGA),
    SPECIES_SPRITE_FRONT(BLASTOISE_GIGA),
    SPECIES_SPRITE_FRONT(BUTTERFREE_GIGA),
    SPECIES_SPRITE_FRONT(PIKACHU_GIGA),
    SPECIES_SPRITE_FRONT(MEOWTH_GIGA),
    SPECIES_SPRITE_FRONT(MACHAMP_GIGA),
    SPECIES_SPRITE_FRONT(GENGAR_GIGA),
    SPECIES_SPRITE_FRONT(KINGLER_GIGA),
    SPECIES_SPRITE_FRONT(LAPRAS_GIGA),
    SPECIES_SPRITE_FRONT(EEVEE_GIGA),
    SPECIES_SPRITE_FRONT(SNORLAX_GIGA),
    SPECIES_SPRITE_FRONT(GARBODOR_GIGA),
    SPECIES_SPRITE_FRONT(MELMETAL_GIGA),
    SPECIES_SPRITE_FRONT(CORVIKNIGHT_GIGA),
    SPECIES_SPRITE_FRONT(ORBEETLE_GIGA),
    SPECIES_SPRITE_FRONT(DREDNAW_GIGA),
    SPECIES_SPRITE_FRONT(COALOSSAL_GIGA),
    SPECIES_SPRITE_FRONT(FLAPPLE_GIGA),
    SPECIES_SPRITE_FRONT(SANDACONDA_GIGA),
    SPECIES_SPRITE_FRONT(TOXTRICITY_GIGA),
    SPECIES_SPRITE_FRONT(HATTERENE_GIGA),
    SPECIES_SPRITE_FRONT(DURALUDON_GIGA),
};
