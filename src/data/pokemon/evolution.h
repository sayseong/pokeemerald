const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    //颤弦蝾螈 高调的样子 低调的样子 是否区分？
    [SPECIES_TOXEL]	         = {{EVO_LEVEL, 30, SPECIES_TOXTRICITY}},

    [SPECIES_CLOBBOPUS]	     = {{EVO_MOVE, MOVE_NONE,/*MOVE_TAUNT*/ SPECIES_GRAPPLOCT}},

    //来悲茶 赝品形态 真品形态 是否区分？
    [SPECIES_SINISTEA]       = {EVO_ITEM, ITEM_NONE,/*ITEM_CHIPPED_POT*/ SPECIES_POLTEAGEIST},
    ...
    //霜奶仙 携带糖饰进化？
    [SPECIES_MILCERY]        = {{EVO_ITEM, ITEM_NONE,/*ITEM_*/ SPECIES_ALCREMIE},
        {EVO_ITEM, ITEM_NONE,/*ITEM_*/ SPECIES_ALCREMIE}},

    //雪绒蛾 夜晚亲密度进化？ {EVO_FRIENDSHIP, 0,
    [SPECIES_SNOM]	         = {{EVO_LEVEL_NIGHT, SPECIES_ALOLAN_MAROWAK}},
    ...
    //武道熊师 不同地图分支 进化怎么写？ 恶之塔 恶之挂轴  水之塔 水之挂轴
    [SPECIES_KUBFU]          = {{EVO_ITEM, ITEM_NONE,/*ITEM_*/ SPECIES_URSHIFU}},
};
