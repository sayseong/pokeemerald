const struct LevelUpMove *const gLevelUpLearnsets[NUM_SPECIES] =
{
    ...
    [SPECIES_BONDED_GRENINJA] = sGreninjaLevelUpLearnset,
    ...
    [SPECIES_BONDED_AERODACTYL] = sAerodactylLevelUpLearnset,
    [SPECIES_BONDED_AGGRON] = sAggronLevelUpLearnset,
    [SPECIES_BONDED_ALAKAZAM] = sAlakazamLevelUpLearnset,
    [SPECIES_BONDED_BEARTIC] = sBearticLevelUpLearnset,
    [SPECIES_BONDED_FLYGON] = sFlygonLevelUpLearnset,
    [SPECIES_BONDED_GROUDON] = sGroudonLevelUpLearnset,
    [SPECIES_BONDED_KYOGRE] = sKyogreLevelUpLearnset,
    [SPECIES_BONDED_RAYQUAZA] = sRayquazaLevelUpLearnset,
};
