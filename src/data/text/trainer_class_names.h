const u8 gTrainerClassNames[][13] = {
    ...
    [TRAINER_CLASS_BLACK_SERAPH_GRUNT] = _("Black Seraph"),
    ...
    [TRAINER_CLASS_TEAM_MAGMA] = _("White Seraph"),
    [TRAINER_CLASS_EXPERT] = _("Expert"),
    [TRAINER_CLASS_AQUA_ADMIN] = _("Black Seraph"),
    [TRAINER_CLASS_BLACK_BELT] = _("Black Belt"),
    [TRAINER_CLASS_AQUA_LEADER] = _("White Seraph"),
    ...
    [TRAINER_CLASS_MAGMA_ADMIN] = _("Grey Seraph"),
    ...
    [TRAINER_CLASS_MAGMA_LEADER] = _("Seraphim"),
