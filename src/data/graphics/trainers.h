...
const u32 gTrainerFrontPic_MagmaGruntDuo[] = INCBIN_U32("graphics/trainers/front_pics/magma_duo.4bpp.lz");
const u32 gTrainerPalette_MagmaGruntDuo[] = INCBIN_U32("graphics/trainers/palettes/magma_duo.gbapal.lz");
