...
// New battle strings.
static const s8 sText_EnduredViaSturdy[] = _("{B_DEF_NAME_WITH_PREFIX}发动{B_DEF_ABILITY}，\n忍受住了攻击!");
static const s8 sText_PowerHerbActivation[] = _("{B_ATK_NAME_WITH_PREFIX}使用{B_LAST_ITEM}\n充满能量!");
static const s8 sText_HurtByItem[] = _("{B_ATK_NAME_WITH_PREFIX}受到\n来自{B_LAST_ITEM}的伤害!");
static const s8 sText_BadlyPoisonedByItem[] = _("{B_EFF_NAME_WITH_PREFIX}受到\n{B_LAST_ITEM}的剧毒!");
static const s8 sText_BurnedByItem[] = _("{B_EFF_NAME_WITH_PREFIX} 受到\n{B_LAST_ITEM}的烧伤!");
static const s8 sText_TargetAbilityActivates[] = _("{B_DEF_NAME_WITH_PREFIX}发动{B_DEF_ABILITY}!");
static const u8 sText_GravityIntensified[] = _("重力变得比以前更强了!");
static const u8 sText_TargetIdentified[] = _("{B_DEF_NAME_WITH_PREFIX}被识破!");
static const u8 sText_TargetWokeUp[] = _("{B_DEF_NAME_WITH_PREFIX}醒了!");
static const u8 sText_PkmnStoleAndAteItem[] = _("{B_ATK_NAME_WITH_PREFIX}偷吃\n{B_DEF_NAME_WITH_PREFIX}的{B_LAST_ITEM}!");
static const u8 sText_TailWindBlew[] = _("{B_ATK_TEAM2}队伍的背后\n刮来了顺风!");
static const u8 sText_PkmnWentBack[] = _("{B_ATK_NAME_WITH_PREFIX}被\n{B_ATK_TRAINER_CLASS}{B_ATK_TRAINER_NAME}收回来了");
static const u8 sText_PkmnCantUseItemsAnymore[] = _("{B_DEF_NAME_WITH_PREFIX}无法\n使用道具!");
static const u8 sText_PkmnFlung[] = _("{B_ATK_NAME_WITH_PREFIX}扔出它的\n{B_LAST_ITEM}!");
static const u8 sText_PkmnPreventedFromHealing[] = _("{B_DEF_NAME_WITH_PREFIX}无法获得治疗!");
static const u8 sText_PkmnSwitchedAtkAndDef[] = _("{B_ATK_NAME_WITH_PREFIX}交换了\n攻击和防御!");
...
static const u8 sText_SwitchedAtkAndSpAtk[] = _("{B_ATK_NAME_WITH_PREFIX}交换了目标的攻击\n和特攻的变化值!");
static const u8 sText_SwitchedDefAndSpDef[] = _("{B_ATK_NAME_WITH_PREFIX}交换了目标的防御\n和特防的变化值!");
static const u8 sText_PkmnAcquiredAbility[] = _("{B_DEF_NAME_WITH_PREFIX}获得\n{B_DEF_ABILITY}!");
static const u8 sText_PoisonSpikesScattered[] = _("对方队伍的脚下撒满了毒菱!");
static const u8 sText_PkmnSwitchedStatChanges[] = _("{B_ATK_NAME_WITH_PREFIX}交换了对方的\n能力变化值!");
static const u8 sText_PkmnSurroundedWithVeilOfWater[] = _("{B_ATK_NAME_WITH_PREFIX}周围\n环绕着水幕!");
static const u8 sText_PkmnLevitatedOnElectromagnetism[] = _("{B_ATK_NAME_WITH_PREFIX}周围\n悬浮着电磁波!");
static const u8 sText_PkmnTwistedDimensions[] = _("{B_ATK_NAME_WITH_PREFIX}的空间发生扭曲!");
static const u8 sText_PointedStonesFloat[] =_("{B_DEF_TEAM2}队伍\n被尖石包围!");
static const u8 sText_CloakedInMysticalMoonlight[] =_("它披上了月光之衣!");
static const u8 sText_TrappedBySwirlingMagma[] =_("{B_DEF_NAME_WITH_PREFIX}被旋转的\n岩浆围困住了!");
static const u8 sText_VanishedInstantly[] =_("{B_ATK_NAME_WITH_PREFIX}去哪里了?");
static const u8 sText_ProtectedTeam[] =_("{B_CURRENT_MOVE}保护了\n{B_ATK_TEAM2}!");
static const u8 sText_SharedItsGuard[] =_("{B_ATK_NAME_WITH_PREFIX}平分了\n对方的防御!");
static const u8 sText_SharedItsPower[] =_("{B_ATK_NAME_WITH_PREFIX}平分了\n对方的攻击!");
static const u8 sText_SwapsDefAndSpDefOfAllPkmn[] =_("它创造了一个神秘空间\n交换精灵的防御和特防!");
static const u8 sText_BecameNimble[] =_("{B_ATK_NAME_WITH_PREFIX}变得更加灵活!");
static const u8 sText_HurledIntoTheAir[] =_("{B_DEF_NAME_WITH_PREFIX}被投飞到空中!");
static const u8 sText_HeldItemsLoseEffects[] =_("它创造了一个奇妙空间\n精灵道具将会失去效果!");
static const u8 sText_FellStraightDown[] =_("{B_DEF_NAME_WITH_PREFIX}\n自由落体!");
static const u8 sText_TransformedIntoWaterType[] =_("{B_DEF_NAME_WITH_PREFIX}变成了水属性!");
...
static const u8 sText_ResetsTargetsStatLevels[] =_("{B_DEF_NAME_WITH_PREFIX}的能力提升\n被抹去了!");
static const u8 sText_AllySwitchPosition[] =_("{B_ATK_NAME_WITH_PREFIX}与\n{B_SCR_ACTIVE_NAME_WITH_PREFIX}交换场地!");
static const u8 sText_RestoreTargetsHealth[] =_("{B_DEF_NAME_WITH_PREFIX}恢复了生命值!");
static const u8 sText_TookPkmnIntoTheSky[] =_("{B_ATK_NAME_WITH_PREFIX}带着\n{B_DEF_NAME_WITH_PREFIX}在天上飞!");
static const u8 sText_FreedFromSkyDrop[] =_("{B_DEF_NAME_WITH_PREFIX}掉下来了!");
static const u8 sText_PostponeTargetMove[] =_("{B_DEF_NAME_WITH_PREFIX}变得迟缓了!");
static const u8 sText_ReflectTargetsType[] =_("{B_ATK_NAME_WITH_PREFIX}的属性\n变成{B_DEF_NAME_WITH_PREFIX}的!");
static const u8 sText_TransferHeldItem[] =_("{B_DEF_NAME_WITH_PREFIX}获取{B_LAST_ITEM}\n来自{B_ATK_NAME_WITH_PREFIX}");
static const u8 sText_EmbargoEnds[] = _("{B_ATK_NAME_WITH_PREFIX}可以重复使用道具!");
static const u8 sText_Electromagnetism[] = _("磁力发动");
...
static const u8 sText_TelekinesisEnds[] = _("{B_ATK_NAME_WITH_PREFIX}不再\n被心灵感应操控!");
static const u8 sText_TailwindEnds[] = _("{B_ATK_TEAM1}的顺风停了耶!");
static const u8 sText_LuckyChantEnds[] = _("{B_ATK_TEAM1}队伍的好运到头了!");
static const u8 sText_TrickRoomEnds[] = _("扭曲空间恢复正常!");
static const u8 sText_WonderRoomEnds[] = _("奇异空间消失\n防御恢复正常!");
static const u8 sText_MagicRoomEnds[] = _("魔法空间消失\n道具重新解放!");
static const u8 sText_MudSportEnds[] = _("泥泞的影响消失了");
static const u8 sText_WaterSportEnds[] = _("水上运动可以暂停了");
static const u8 sText_GravityEnds[] = _("重力恢复正常!");
static const u8 sText_AquaRingHeal[] = _("水流环恢复了\n{B_ATK_NAME_WITH_PREFIX}的生命值!");
...
static const u8 sText_ElectricTerrainEnds[] = _("电场消失.");
static const u8 sText_MistyTerrainEnds[] = _("迷雾散去.");
static const u8 sText_PsychicTerrainEnds[] = _("精神空间消失.");
static const u8 sText_GrassyTerrainEnds[] = _("草地消失.");
static const u8 sText_AngryPointActivates[] = _("{B_DEF_NAME_WITH_PREFIX}的{B_DEF_ABILITY}\n最大化它的攻击!");
static const u8 sText_PoisonHealHpUp[] = _("{B_ATK_NAME_WITH_PREFIX}从毒液中\n恢复了一点点!");
static const u8 sText_BadDreamsDmg[] = _("{B_DEF_NAME_WITH_PREFIX}受到\n{B_ATK_ABILITY}的折磨!");
static const u8 sText_MoldBreakerEnters[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}威严降临!");
static const u8 sText_TeravoltEnters[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}带着\n爆炸光环登场!");
static const u8 sText_TurboblazeEnters[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}带着\n闪耀光环登场!");
static const u8 sText_SlowStartEnters[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}启动失败!");
static const u8 sText_SlowStartEnd[] = _("{B_ATK_NAME_WITH_PREFIX}好不容易\n启动成功了耶!");
static const u8 sText_SolarPowerHpDrop[] = _("{B_ATK_NAME_WITH_PREFIX}的{B_ATK_ABILITY}\n反而被太阳灼伤!");
static const u8 sText_AftermathDmg[] = _("{B_ATK_NAME_WITH_PREFIX}受伤了!");
static const u8 sText_AnticipationActivates[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}感到毛骨悚然!");
static const u8 sText_ForewarnActivates[] = _("{B_SCR_ACTIVE_ABILITY}预知{B_SCR_ACTIVE_NAME_WITH_PREFIX}\n的{B_DEF_NAME_WITH_PREFIX}的{B_BUFF1}!");
static const u8 sText_IceBodyHpGain[] = _("{B_ATK_NAME_WITH_PREFIX}的{B_ATK_ABILITY}\n获得了一点点治疗!");
static const u8 sText_SnowWarningHail[] = _("开始下冰雹咯!");
static const u8 sText_FriskActivates[] = _("{B_ATK_NAME_WITH_PREFIX}搜遍{B_DEF_NAME_WITH_PREFIX}全身\n但是只找到了{B_LAST_ITEM}!");
static const u8 sText_UnnerveEnters[] = _("对方的队伍被吓得慌不择食!");
static const u8 sText_HarvestBerry[] = _("{B_ATK_NAME_WITH_PREFIX}收获{B_LAST_ITEM}!");
static const u8 sText_MoxieAtkRise[] = _("{B_ATK_NAME_WITH_PREFIX}的{B_ATK_ABILITY}提升了他的攻击!");
static const u8 sText_MagicBounceActivates[] = _("{B_DEF_NAME_WITH_PREFIX}反射\n{B_ATK_NAME_WITH_PREFIX}回去了!");
static const u8 sText_ProteanTypeChange[] = _("{B_ATK_NAME_WITH_PREFIX}的{B_ATK_ABILITY} 变成\n{B_BUFF1}属性!");
static const u8 sText_SymbiosisItemPass[] = _("{B_ATK_NAME_WITH_PREFIX}通过{B_ATK_ABILITY}\n传递{B_LAST_ITEM}给了{B_SCR_ACTIVE_NAME_WITH_PREFIX}!");
static const u8 sText_StealthRockDmg[] = _("尖锐的石头戳伤了\n{B_SCR_ACTIVE_NAME_WITH_PREFIX}!");
static const u8 sText_ToxicSpikesAbsorbed[] = _("敌方队伍的毒菱消失了!");
static const u8 sText_ToxicSpikesPoisoned[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}中毒了!");
static const u8 sText_StickyWebSwitchIn[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}被黏黏网\n粘住了!");
static const u8 sText_HealingWishCameTrue[] = _("{B_ATK_NAME_WITH_PREFIX}愿望实现!");
static const u8 sText_HealingWishHealed[] = _("{B_ATK_NAME_WITH_PREFIX}重获治疗!");
static const u8 sText_LunarDanceCameTrue[] = _("{B_ATK_NAME_WITH_PREFIX}沐浴着月之光芒!");
static const u8 sText_CursedBodyDisabled[] = _("{B_ATK_NAME_WITH_PREFIX}的{B_BUFF1}被\n{B_DEF_NAME_WITH_PREFIX}的{B_DEF_ABILITY}封印了!");
static const u8 sText_AttackerAquiredAbility[] = _("{B_ATK_NAME_WITH_PREFIX}获得{B_LAST_ABILITY}!");
static const u8 sText_TargetStatWontGoHigher[] = _("{B_DEF_NAME_WITH_PREFIX}的{B_BUFF1}\n不能再提升了!");
static const u8 sText_PkmnMoveBouncedViaAbility[] = _("{B_ATK_NAME_WITH_PREFIX}的{B_CURRENT_MOVE}攻击\n被{B_DEF_NAME_WITH_PREFIX}的{B_DEF_ABILITY}反弹回去了!");
static const u8 sText_ImposterTransform[] = _("{B_ATK_NAME_WITH_PREFIX}样子变成\n和{B_DEF_NAME_WITH_PREFIX}一样了!");
static const u8 sText_NotDoneYet[] = _("还没做!");
static const u8 sText_PkmnBlewAwayToxicSpikes[] = _("{B_ATK_NAME_WITH_PREFIX}清理掉\n场上的毒菱!");
static const u8 sText_PkmnBlewAwayStickyWeb[] = _("{B_ATK_NAME_WITH_PREFIX}清理掉\n场上的黏黏网!");
static const u8 sText_PkmnBlewAwayStealthRock[] = _("{B_ATK_NAME_WITH_PREFIX}清理掉\n场上的隐形岩石!");
static const u8 sText_StickyWebUsed[] = _("{B_DEF_TEAM2}的队伍\n被撒下黏黏网!");
static const u8 sText_QuashSuccess[] = _("{B_ATK_NAME_WITH_PREFIX}队伍的技能被延迟释放了!");
static const u8 sText_IonDelugeOn[] = _("大量离子阵雨洒向战场!");
static const u8 sText_TopsyTurvySwitchedStats[] = _("{B_DEF_NAME_WITH_PREFIX}的能力\n变化被反转了!");
static const u8 sText_TerrainBecomesMisty[] = _("战争迷雾!");
static const u8 sText_TerrainBecomesGrassy[] = _("长草了!");
static const u8 sText_TerrainBecomesElectric[] = _("电磁场!");
static const u8 sText_TerrainBecomesPsychic[] = _("精神场地发动!");
static const u8 sText_TargetElectrified[] = _("{B_DEF_NAME_WITH_PREFIX}的\n技能充满电了!");
static const u8 sText_AssaultVestDoesntAllow[] = _("携带了{B_LAST_ITEM}\n无法使用变化招式!");
static const u8 sText_GravityPreventsUsage[] = _("由于重力的作用,\n{B_ATK_NAME_WITH_PREFIX}无法使用{B_CURRENT_MOVE}!");
static const u8 sText_HealBlockPreventsUsage[] = _("{B_ATK_NAME_WITH_PREFIX}无法获得治疗!");
static const u8 sText_MegaEvoReacting[] = _("{B_ATK_NAME_WITH_PREFIX}的{B_LAST_ITEM}对\n{B_ATK_TRAINER_NAME}的百万手镯产生了共鸣!");
static const u8 sText_MegaEvoEvolved[] = _("{B_ATK_NAME_WITH_PREFIX}百万进化\n成为百万{B_BUFF1}!");
static const u8 sText_drastically[] = _("巨大的");
static const u8 sText_severely[] = _("急剧的");
static const u8 sText_Infestation[] = _("{B_DEF_NAME_WITH_PREFIX}受到了\n{B_ATK_NAME_WITH_PREFIX}的折磨!");
static const u8 sText_NoEffectOnTarget[] = _("对{B_DEF_NAME_WITH_PREFIX}没有效果!");
static const u8 sText_BurstingFlames[] = _("爆裂火焰命中了\n{B_SCR_ACTIVE_NAME_WITH_PREFIX}!");
static const u8 sText_BestowItemGiving[] = _("{B_DEF_NAME_WITH_PREFIX}从{B_ATK_NAME_WITH_PREFIX}\n收到了{B_LAST_ITEM}!");
static const u8 sText_ThirdTypeAdded[] = _("{B_DEF_NAME_WITH_PREFIX}获得\n{B_BUFF1}属性!");
static const u8 sText_FellForFeint[] = _("{B_DEF_NAME_WITH_PREFIX}上当受骗!");
static const u8 sText_PokemonCannotUseMove[] = _("{B_ATK_NAME_WITH_PREFIX}无法\n使用{B_CURRENT_MOVE}!");
static const u8 sText_CoveredInPowder[] = _("{B_DEF_NAME_WITH_PREFIX}被粉末覆盖了!");
static const u8 sText_PowderExplodes[] = _("粉尘被火焰引燃!");
static const u8 sText_BelchCantUse[] = _("无法打嗝!");
static const u8 sText_SpectralThiefSteal[] = _("{B_ATK_NAME_WITH_PREFIX}偷走了\n对方的能力强化!");
static const u8 sText_GravityGrounding[] = _("{B_DEF_NAME_WITH_PREFIX}飞不起来了!");
static const u8 sText_MistyTerrainPreventsStatus[] = _("{B_DEF_NAME_WITH_PREFIX}被\n迷雾保护了!");
static const u8 sText_GrassyTerrainHeals[] = _("{B_ATK_NAME_WITH_PREFIX}吃了点草!");
static const u8 sText_ElectricTerrainPreventsSleep[] = _("{B_DEF_NAME_WITH_PREFIX}被\n电磁场保护了!");
static const u8 sText_PsychicTerrainPreventsPriority[] = _("{B_DEF_NAME_WITH_PREFIX}被\n精神场地保护了!");
static const u8 sText_SafetyGooglesProtected[] = _("{B_DEF_NAME_WITH_PREFIX}发动{B_LAST_ITEM},\n阻挡了敌方的攻击!");
static const u8 sText_FlowerVeilProtected[] = _("{B_DEF_NAME_WITH_PREFIX}被\n花海保护了!");
static const u8 sText_SweetVeilProtected[] = _("{B_DEF_NAME_WITH_PREFIX}被\n甜幕保护了!");
static const u8 sText_AromaVeilProtected[] = _("{B_DEF_NAME_WITH_PREFIX}被\n芳香保护了!");
static const u8 sText_CelebrateMessage[] = _("你走狗运了, {B_PLAYER_NAME}!");
static const u8 sText_UsedInstructedMove[] = _("{B_ATK_NAME_WITH_PREFIX}被{B_BUFF1}号令!");
static const u8 sText_LaserFocusMessage[] = _("{B_ATK_NAME_WITH_PREFIX}\n集中精神!");
static const u8 sText_GemActivates[] = _("{B_LAST_ITEM}强化\n{B_ATK_NAME_WITH_PREFIX}的攻击力!");
static const u8 sText_BerryDmgReducing[] = _("{B_LAST_ITEM}弱化了\n{B_DEF_NAME_WITH_PREFIX}的伤害!");
static const u8 sText_TargetAteItem[] = _("{B_DEF_NAME_WITH_PREFIX}吃掉了{B_LAST_ITEM}!");
static const u8 sText_AirBalloonFloat[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}通过\n{B_LAST_ITEM}悬浮在了空中!");
static const u8 sText_AirBalloonPop[] = _("{B_DEF_NAME_WITH_PREFIX}的{B_LAST_ITEM}炸了!");
static const u8 sText_IncinerateBurn[] = _("{B_EFF_NAME_WITH_PREFIX}的{B_LAST_ITEM}\n被烧毁了!");
static const u8 sText_BugBite[] = _("{B_ATK_NAME_WITH_PREFIX}偷吃\n{B_EFF_NAME_WITH_PREFIX}的{B_LAST_ITEM}!");
static const u8 sText_IllusionWoreOff[] = _("{B_DEF_NAME_WITH_PREFIX}的幻象\n被揭穿了!");
static const u8 sText_AttackerCuredTargetStatus[] = _("{B_ATK_NAME_WITH_PREFIX}治愈了\n{B_DEF_NAME_WITH_PREFIX}的状态!");
static const u8 sText_AttackerLostFireType[] = _("{B_ATK_NAME_WITH_PREFIX}把自己烧坏了!");
static const u8 sText_HealerCure[] = _("{B_ATK_NAME_WITH_PREFIX}的{B_LAST_ABILITY}\n治疗了{B_SCR_ACTIVE_NAME_WITH_PREFIX}的状态!");
static const u8 sText_ReceiverAbilityTakeOver[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}的{B_SCR_ACTIVE_ABILITY}\n被接管!");
static const u8 sText_PkmnAbsorbingPower[] = _("{B_ATK_NAME_WITH_PREFIX}正在提升!");
