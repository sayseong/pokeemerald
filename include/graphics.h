...
extern const u32 gMonFrontPic_VENUSAUR_GIGA[];
extern const u32 gMonBackPic_VENUSAUR_GIGA[];
extern const u32 gMonPalette_VENUSAUR_GIGA[];
extern const u32 gMonShinyPalette_VENUSAUR_GIGA[];
extern const u32 gMonFrontPic_CHARIZARD_GIGA[];
extern const u32 gMonBackPic_CHARIZARD_GIGA[];
extern const u32 gMonPalette_CHARIZARD_GIGA[];
extern const u32 gMonShinyPalette_CHARIZARD_GIGA[];
extern const u32 gMonFrontPic_BLASTOISE_GIGA[];
extern const u32 gMonBackPic_BLASTOISE_GIGA[];
extern const u32 gMonPalette_BLASTOISE_GIGA[];
extern const u32 gMonShinyPalette_BLASTOISE_GIGA[];
extern const u32 gMonFrontPic_BUTTERFREE_GIGA[];
extern const u32 gMonBackPic_BUTTERFREE_GIGA[];
extern const u32 gMonPalette_BUTTERFREE_GIGA[];
extern const u32 gMonShinyPalette_BUTTERFREE_GIGA[];
extern const u32 gMonFrontPic_PIKACHU_GIGA[];
extern const u32 gMonBackPic_PIKACHU_GIGA[];
extern const u32 gMonPalette_PIKACHU_GIGA[];
extern const u32 gMonShinyPalette_PIKACHU_GIGA[];
extern const u32 gMonFrontPic_MEOWTH_GIGA[];
extern const u32 gMonBackPic_MEOWTH_GIGA[];
extern const u32 gMonPalette_MEOWTH_GIGA[];
extern const u32 gMonShinyPalette_MEOWTH_GIGA[];
extern const u32 gMonFrontPic_MACHAMP_GIGA[];
extern const u32 gMonBackPic_MACHAMP_GIGA[];
extern const u32 gMonPalette_MACHAMP_GIGA[];
extern const u32 gMonShinyPalette_MACHAMP_GIGA[];
extern const u32 gMonFrontPic_GENGAR_GIGA[];
extern const u32 gMonBackPic_GENGAR_GIGA[];
extern const u32 gMonPalette_GENGAR_GIGA[];
extern const u32 gMonShinyPalette_GENGAR_GIGA[];
extern const u32 gMonFrontPic_KINGLER_GIGA[];
extern const u32 gMonBackPic_KINGLER_GIGA[];
extern const u32 gMonPalette_KINGLER_GIGA[];
extern const u32 gMonShinyPalette_KINGLER_GIGA[];
extern const u32 gMonFrontPic_LAPRAS_GIGA[];
extern const u32 gMonBackPic_LAPRAS_GIGA[];
extern const u32 gMonPalette_LAPRAS_GIGA[];
extern const u32 gMonShinyPalette_LAPRAS_GIGA[];
extern const u32 gMonFrontPic_EEVEE_GIGA[];
extern const u32 gMonBackPic_EEVEE_GIGA[];
extern const u32 gMonPalette_EEVEE_GIGA[];
extern const u32 gMonShinyPalette_EEVEE_GIGA[];
extern const u32 gMonFrontPic_SNORLAX_GIGA[];
extern const u32 gMonBackPic_SNORLAX_GIGA[];
extern const u32 gMonPalette_SNORLAX_GIGA[];
extern const u32 gMonShinyPalette_SNORLAX_GIGA[];
extern const u32 gMonFrontPic_GARBODOR_GIGA[];
extern const u32 gMonBackPic_GARBODOR_GIGA[];
extern const u32 gMonPalette_GARBODOR_GIGA[];
extern const u32 gMonShinyPalette_GARBODOR_GIGA[];
extern const u32 gMonFrontPic_MELMETAL_GIGA[];
extern const u32 gMonBackPic_MELMETAL_GIGA[];
extern const u32 gMonPalette_MELMETAL_GIGA[];
extern const u32 gMonShinyPalette_MELMETAL_GIGA[];
extern const u32 gMonFrontPic_CORVIKNIGHT_GIGA[];
extern const u32 gMonBackPic_CORVIKNIGHT_GIGA[];
extern const u32 gMonPalette_CORVIKNIGHT_GIGA[];
extern const u32 gMonShinyPalette_CORVIKNIGHT_GIGA[];
extern const u32 gMonFrontPic_ORBEETLE_GIGA[];
extern const u32 gMonBackPic_ORBEETLE_GIGA[];
extern const u32 gMonPalette_ORBEETLE_GIGA[];
extern const u32 gMonShinyPalette_ORBEETLE_GIGA[];
extern const u32 gMonFrontPic_DREDNAW_GIGA[];
extern const u32 gMonBackPic_DREDNAW_GIGA[];
extern const u32 gMonPalette_DREDNAW_GIGA[];
extern const u32 gMonShinyPalette_DREDNAW_GIGA[];
extern const u32 gMonFrontPic_COALOSSAL_GIGA[];
extern const u32 gMonBackPic_COALOSSAL_GIGA[];
extern const u32 gMonPalette_COALOSSAL_GIGA[];
extern const u32 gMonShinyPalette_COALOSSAL_GIGA[];
extern const u32 gMonFrontPic_FLAPPLE_GIGA[];
extern const u32 gMonBackPic_FLAPPLE_GIGA[];
extern const u32 gMonPalette_FLAPPLE_GIGA[];
extern const u32 gMonShinyPalette_FLAPPLE_GIGA[];
extern const u32 gMonFrontPic_SANDACONDA_GIGA[];
extern const u32 gMonBackPic_SANDACONDA_GIGA[];
extern const u32 gMonPalette_SANDACONDA_GIGA[];
extern const u32 gMonShinyPalette_SANDACONDA_GIGA[];
extern const u32 gMonFrontPic_TOXTRICITY_GIGA[];
extern const u32 gMonBackPic_TOXTRICITY_GIGA[];
extern const u32 gMonPalette_TOXTRICITY_GIGA[];
extern const u32 gMonShinyPalette_TOXTRICITY_GIGA[];
extern const u32 gMonFrontPic_HATTERENE_GIGA[];
extern const u32 gMonBackPic_HATTERENE_GIGA[];
extern const u32 gMonPalette_HATTERENE_GIGA[];
extern const u32 gMonShinyPalette_HATTERENE_GIGA[];
extern const u32 gMonFrontPic_DURALUDON_GIGA[];
extern const u32 gMonBackPic_DURALUDON_GIGA[];
extern const u32 gMonPalette_DURALUDON_GIGA[];
extern const u32 gMonShinyPalette_DURALUDON_GIGA[];
