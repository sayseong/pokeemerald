...
#define DIFFICULTY_MID 1
#define DIFFICULTY_HARD 2
#define DIFFICULTY_INSANE 3
#define DIFFICULTY_COUNT 4

#define OPTIONS_TRANSITION_SLOW 0
#define OPTIONS_TRANSITION_MID 1
#define OPTIONS_TRANSITION_FAST 2
#define OPTIONS_TRANSITION_INSTANT 3
