...
#define ABILITY_INTREPID_SWORD = 234 //不挠之剑
#define ABILITY_DAUNTLESS_SHIELD = 235 //不屈之盾
#define ABILITY_LIBERO = 236 //自由者
#define ABILITY_BALL_FETCH = 237 //捡球
#define ABILITY_COTTON_DOWN = 238 //棉絮
#define ABILITY_PROPELLER_TAIL = 239 //螺旋尾鳍
#define ABILITY_MIRROR_ARMOR = 240 //镜甲
#define ABILITY_GULP_MISSILE = 241 //一口导弹
#define ABILITY_STALWART = 242 //坚毅
#define ABILITY_STEAM_ENGINE = 243 //蒸汽机
#define ABILITY_PUNK_ROCK = 244 //庞克摇滚
#define ABILITY_SAND_SPIT = 245 //吐沙
#define ABILITY_ICE_SCALES = 246 //冰鳞粉
#define ABILITY_RIPEN = 247 //熟成
#define ABILITY_ICE_FACE = 248 //结冻头
#define ABILITY_POWER_SPOT = 249 //能量点
#define ABILITY_MIMICRY = 250 //拟态
#define ABILITY_SCREEN_CLEANER = 251 //除障
#define ABILITY_STEELY_SPIRIT = 252 //钢之意志
#define ABILITY_PERISH_BODY = 253 //灭亡之躯
#define ABILITY_WANDERING_SPIRIT = 254 //游魂
#define ABILITY_GORILLA_TACTICS = 255 //一猩一意
#define ABILITY_NEUTRALIZING_GAS = 256 //化学变化气体
#define ABILITY_PASTEL_VEIL = 257 //粉彩护幕
#define ABILITY_HUNGER_SWITCH = 258 //饱了又饿
