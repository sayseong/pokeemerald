...
u32 CreateMegaIndicatorSprite(u32 battlerId, const struct SpritePalette* sSpritePalette_MegaIndicator, const struct SpriteSheet *sSpriteSheet_MegaIndicator, const struct SpriteTemplate *sSpriteTemplate_MegaIndicator);
